...
module router::renewal_domain_tests {
    ...
    inline fun get_v2_expiration(
        ...
        let expiration_time_sec = aptos_names_v2_1::v2_domains::get_expiration(domain_name, subdomain_name);
        expiration_time_sec
    }
    ...
    fun test_renew_v1_name_not_eligible_for_free_extension_should_trigger_auto_migration(
        ...
        // Domain should be auto migrated to v2 and renewed with 1 year
        {
            ...
            assert!(!aptos_names_v2_1::v2_domains::is_name_expired(domain_name, option::none()), 3);
    ...
    #[expected_failure(abort_code = 196626, location = aptos_names_v2_1::v2_domains)]
    ...
    #[expected_failure(abort_code = 196639, location = aptos_names_v2_1::v2_domains)]
