...
module router::subdomain_transfer_tests {
    ...
    fun test_register_subdomain_with_subdomain_owner_transfer_disabled(
        ...
        let token_addr =
            aptos_names_v2_1::v2_1_domains::get_token_addr(domain_name, subdomain_name_opt);
        object::transfer(user2,
            object::address_to_object<aptos_names_v2_1::v2_1_domains::NameRecord>(
                token_addr),
            user1_addr,);
    }
    ...
    fun test_register_subdomain_with_subdomain_owner_transfer_enabled_and_disable_subdomain_owner_transfer(
        ...
        router::domain_admin_set_subdomain_transferability(user1, domain_name,
    ...
    fun test_register_subdomain_with_subdomain_owner_transfer_disabled_and_domain_admin_can_still_transfer(
        ...
        router::domain_admin_transfer_subdomain(user1,
            domain_name,
            subdomain_name,
            user1_addr,
