...
module aptos_names::test_helper {
    ...
    public fun register_name(
        ...
        let maybe_target_address = domains::name_resolved_address(subdomain_name,
            domain_name);
        ...
        let is_expired_before =
            domains::name_is_registered(subdomain_name, domain_name) && domains::name_is_expired(
        ...
        let years =
            (time_helper::seconds_to_years(registration_duration_secs) as u8);
        if (option::is_none(&subdomain_name)) {
            ...
            domains::register_subdomain(user, *option::borrow(&subdomain_name), domain_name,
        ...
        assert!(is_owner, 3);
        let (is_owner, token_id) = domains::is_token_owner(user_addr, subdomain_name,
            domain_name);
        let (tdi_creator, tdi_collection, tdi_name, tdi_property_version) = token::get_token_id_fields(
            &token_id);
        ...
        test_utils::print_actual_expected(b"tdi_name: ", tdi_name, expected_fq_domain_name,
            false);
        assert!(tdi_name == expected_fq_domain_name, 6);
        test_utils::print_actual_expected(b"tdi_property_version: ", tdi_property_version,
            expected_property_version, false);
        ...
        test_utils::print_actual_expected(b"user_balance_after: ", user_balance_after,
            expected_user_balance_after, false);
        assert!(user_balance_after == expected_user_balance_after,
        ...
        assert!(time_helper::seconds_to_days(expiration_time_sec - timestamp::now_seconds()) ==
             365, 10);
        ...
        test_utils::print_actual_expected(b"property_version: ", property_version,
            expected_property_version, false);
        ...
        let register_name_event_v1_num_emitted =
            domains::get_register_name_event_v1_count() - register_name_event_v1_event_count_before;
        let set_name_address_event_v1_num_emitted =
            domains::get_set_name_address_event_v1_count() - set_name_address_event_v1_event_count_before;
        let set_reverse_lookup_event_v1_num_emitted =
            domains::get_set_reverse_lookup_event_v1_count() - set_reverse_lookup_event_v1_event_count_before;

        test_utils::print_actual_expected(b"register_name_event_v1_num_emitted: ",
            register_name_event_v1_num_emitted, 1, false);
        ...
        if (option::is_none(&user_reverse_lookup_before)) {
            ...
            if (option::is_some(&maybe_reverse_lookup_after)) {
                ...
                assert!(*reverse_lookup_after
                    == domains::create_name_record_key_v1(subdomain_name, domain_name), 36);
            } else {
            ...
            if (option::is_some(&name_reverse_lookup_before) && is_expired_before) {
                assert!(set_reverse_lookup_event_v1_num_emitted == 2,
                    set_reverse_lookup_event_v1_num_emitted);
            } else {
                assert!(set_reverse_lookup_event_v1_num_emitted == 1,
                    set_reverse_lookup_event_v1_num_emitted);
            }
        } else {
            ...
            if (option::is_some(&name_reverse_lookup_before)
                ...
                assert!(set_reverse_lookup_event_v1_num_emitted == 0,
                    set_reverse_lookup_event_v1_num_emitted);
            }
        };
        ...
        if (is_subdomain) {
            if (option::is_none(&user_reverse_lookup_before)) {
                ...
                test_utils::print_actual_expected(
                    ...
                    set_name_address_event_v1_num_emitted, 1, false);
                assert!(set_name_address_event_v1_num_emitted == 1,
                    set_name_address_event_v1_num_emitted);
            } else {
                // We haven't set a target address yet!
                test_utils::print_actual_expected(
                    b"set_name_address_event_v1_num_emitted: ",
                    set_name_address_event_v1_num_emitted, 0, false);
                assert!(set_name_address_event_v1_num_emitted == 0,
                    set_name_address_event_v1_num_emitted);
            }
        } else {
            // Should automatically point to the users address
            test_utils::print_actual_expected(b"set_name_address_event_v1_num_emitted: ",
                set_name_address_event_v1_num_emitted, 1, false);
            assert!(set_name_address_event_v1_num_emitted == 1,
                set_name_address_event_v1_num_emitted);
        };
    ...
    public fun set_name_address(
        ...
        let (_property_version, _expiration_time_sec, target_address) =
            domains::get_name_record_v1_props_for_name(subdomain_name, domain_name);
        test_utils::print_actual_expected(b"set_domain_address: ", target_address,
            option::some(expected_target_address), false);
        ...
        test_utils::print_actual_expected(b"register_name_event_v1_num_emitted: ",
            register_name_event_v1_num_emitted, 0, false);
        ...
        if (option::is_some(&maybe_reverse_lookup_before)) {
            let (maybe_reverse_subdomain, reverse_domain) =
                domains::get_name_record_key_v1_props(option::borrow(&maybe_reverse_lookup_before));
    ...
    public fun clear_name_address(
        ...
        if (option::is_none(&subdomain_name)) {
            ...
            domains::clear_subdomain_address(user, *option::borrow(&subdomain_name),
                domain_name);
        };
        let (_property_version, _expiration_time_sec, target_address) =
            domains::get_name_record_v1_props_for_name(subdomain_name, domain_name);
        test_utils::print_actual_expected(b"clear_domain_address: ", target_address,
            option::none(), false);
