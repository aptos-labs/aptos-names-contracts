...
module aptos_names_v2::subdomain_e2e_tests {
    ...
    fun test_names_are_registerable_after_expiry_e2e(
        ...
        assert!(domains::is_name_registerable(option::none(), test_helper::domain_name()), 82);
        ...
        assert!(!domains::is_name_registerable(option::some(test_helper::subdomain_name()), test_helper::domain_name()), 92);
        ...
        assert!(domains::is_name_registerable(option::some(test_helper::subdomain_name()), test_helper::domain_name()), 95);
