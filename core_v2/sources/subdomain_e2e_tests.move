...
module aptos_names_v2::subdomain_e2e_tests {
    ...
    fun happy_path_e2e_test(
        ...
        test_helper::set_target_address(
            user,
            option::some(test_helper::subdomain_name()),
            test_helper::domain_name(),
            user_addr
        ...
        test_helper::clear_target_address(
            user,
            option::some(test_helper::subdomain_name()),
            test_helper::domain_name()
        );
    ...
    fun test_register_subdomain_with_invalid_string(
        ...
        test_helper::register_name(
            router_signer,
            user,
            option::some(test_helper::invalid_subdomain_name()),
            test_helper::domain_name(),
    ...
    fun test_auto_renew_subdomain_e2e(
        ...
        assert!(
            domains::get_subdomain_renewal_policy(test_helper::domain_name(), test_helper::subdomain_name()) == 0,
            2
        );
        ...
        let (original_expiration_time_sec, _) = domains::get_name_record_v1_props_for_name(
            option::some(test_helper::subdomain_name()),
            test_helper::domain_name()
        );
    ...
    fun test_set_subdomain_renewal_policy(
        ...
        domains::set_subdomain_renewal_policy(user, test_helper::domain_name(), test_helper::subdomain_name(), 1);
        assert!(
            domains::get_subdomain_renewal_policy(test_helper::domain_name(), test_helper::subdomain_name()) == 1,
            3
        );
    ...
    fun test_set_expiration_date_for_subdomain(
        ...
        domains::set_subdomain_expiration_as_domain_owner(
            user,
            test_helper::domain_name(),
            test_helper::subdomain_name(),
        ...
        let (domain_expiration_time_sec, _) = domains::get_name_record_v1_props_for_name(
            option::none(),
            test_helper::domain_name()
        );
    ...
    fun test_names_are_registerable_after_expiry_e2e(
        ...
        assert!(
            domains::name_is_registered(option::some(test_helper::subdomain_name()), test_helper::domain_name()),
            91
        );
        assert!(
            !domains::name_is_registerable(option::some(test_helper::subdomain_name()), test_helper::domain_name()),
            92
        );
