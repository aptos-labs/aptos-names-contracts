#[test_only]
module aptos_names_v2::v2_1_subdomain_e2e_tests {
    ...
    fun happy_path_e2e_test(
        ...
        v2_1_test_helper::clear_target_address(user, option::some(
            v2_1_test_helper::subdomain_name()), v2_1_test_helper::domain_name());

        // And also can clear if is registered address, but not owner
        v2_1_test_helper::set_target_address(user, v2_1_test_helper::domain_name(), option::some(
            v2_1_test_helper::subdomain_name()), signer::address_of(rando));
        v2_1_test_helper::clear_target_address(rando, option::some(
            v2_1_test_helper::subdomain_name()), v2_1_test_helper::domain_name());
    }
    ...
    #[expected_failure(abort_code = 131083, location = aptos_names_v2::v2_1_domains)]
    ...
    fun test_auto_renew_subdomain_e2e(
        ...
        assert!(
            v2_1_domains::get_subdomain_renewal_policy(
                v2_1_test_helper::domain_name(), v2_1_test_helper::subdomain_name()) == 0, 2);
        ...
        let original_expiration_time_sec = v2_1_domains::get_expiration(
            v2_1_test_helper::domain_name(), option::some(v2_1_test_helper::subdomain_name()));
    ...
    #[expected_failure(abort_code = 65562, location = aptos_names_v2::v2_1_domains)]
    fun test_set_subdomain_expiration_policy(
        ...
        assert!(
            v2_1_domains::get_subdomain_renewal_policy(
                v2_1_test_helper::domain_name(), v2_1_test_helper::subdomain_name()) == 1, 3);
    ...
    fun test_admin_can_force_renew_subdomain_name(
        ...
        v2_1_domains::force_set_name_expiration(aptos_names_v2, v2_1_test_helper::domain_name(), option::some(
    ...
    #[expected_failure(abort_code = 327686, location = aptos_names_v2::v2_1_domains)]
    ...
    #[expected_failure(abort_code = 196632, location = aptos_names_v2::v2_1_domains)]
    ...
    #[expected_failure(abort_code = 65561, location = aptos_names_v2::v2_1_domains)]
    ...
    fun test_names_are_registerable_after_expiry_past_grace_e2e(
        ...
        assert!(
            v2_1_domains::is_name_expired(
                v2_1_test_helper::domain_name(), option::some(v2_1_test_helper::subdomain_name())), 90);
        assert!(
        ...
        assert!(
            v2_1_domains::is_name_expired(
                v2_1_test_helper::domain_name(), option::some(v2_1_test_helper::subdomain_name())), 93);
        assert!(
            v2_1_domains::is_name_registered(
    ...
    fun test_dont_allow_rando_to_set_subdomain_address_e2e(
        ...
        v2_1_test_helper::set_target_address(rando, v2_1_test_helper::domain_name(), option::some(
            v2_1_test_helper::subdomain_name()), @aptos_names_v2);
    }
    ...
    fun test_admin_can_force_set_subdomain_address_e2e(
        ...
        v2_1_domains::force_set_target_address(aptos_names_v2, v2_1_test_helper::domain_name(), option::some(
    ...
    fun test_admin_can_force_seize_subdomain_name_e2e(
        ...
        v2_1_domains::force_create_or_seize_name(aptos_names_v2, v2_1_test_helper::domain_name(), option::some(
            v2_1_test_helper::subdomain_name()), v2_1_test_helper::one_year_secs());
        let is_owner = v2_1_domains::is_token_owner(signer::address_of(aptos_names_v2), v2_1_test_helper::domain_name(), option::some(
            v2_1_test_helper::subdomain_name()));
        let is_expired = v2_1_domains::is_name_expired(v2_1_test_helper::domain_name(), option::some(
            v2_1_test_helper::subdomain_name()));
        assert!(is_owner && !is_expired, 2);
    ...
    #[expected_failure(abort_code = 131096, location = aptos_names_v2::v2_1_domains)]
