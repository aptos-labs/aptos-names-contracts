...
module aptos_names_v2::domain_e2e_tests {
    ...
    fun set_primary_name_after_transfer_clears_old_primary_name_e2e_test(
        ...
        domains::set_target_address_and_reverse_lookup(rando, option::none(), domain_name_str);
    ...
    fun test_register_domain_set_target_address_to_rando_and_not_set_transfer_to_address(
        aptos_names: &signer,
        aptos_names_v2: &signer,
        user: signer,
        aptos: signer,
    ...
    fun test_register_domain_not_set_target_address_and_set_transfer_to_address_to_rando(
        aptos_names: &signer,
        aptos_names_v2: &signer,
        user: signer,
        aptos: signer,
    ...
    fun test_register_domain_set_target_address_to_rando_and_set_transfer_to_address_to_rando(
        aptos_names: &signer,
        aptos_names_v2: &signer,
        user: signer,
        aptos: signer,
