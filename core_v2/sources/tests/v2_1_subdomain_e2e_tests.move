...
module aptos_names_v2_1::v2_1_subdomain_e2e_tests {
    ...
    fun happy_path_e2e_test(
        ...
        v2_1_test_helper::set_target_address(user,
            v2_1_test_helper::domain_name(),
            option::some(v2_1_test_helper::subdomain_name()),
            user_addr);

        // Ensure these also work :-)
        v2_1_test_helper::clear_target_address(user,
            option::some(v2_1_test_helper::subdomain_name()),
            v2_1_test_helper::domain_name());
        ...
        v2_1_test_helper::clear_target_address(rando,
            option::some(v2_1_test_helper::subdomain_name()),
            v2_1_test_helper::domain_name());
    }
    ...
    fun test_auto_renew_subdomain_e2e(
        ...
        assert!(v2_1_domains::get_subdomain_renewal_policy(v2_1_test_helper::domain_name(),
                v2_1_test_helper::subdomain_name()) == 0,
            2);
        // The subdomain auto-renewal policy is set to auto_renew
        v2_1_domains::set_subdomain_expiration_policy(user, v2_1_test_helper::domain_name(),
            v2_1_test_helper::subdomain_name(), 1);

        // Renew the domain (and the subdomain should be auto renewed)
        let original_expiration_time_sec =
            v2_1_domains::get_expiration(v2_1_test_helper::domain_name(),
                option::some(v2_1_test_helper::subdomain_name()));
    ...
    fun test_set_subdomain_expiration_policy(
        ...
        v2_1_domains::set_subdomain_expiration_policy(user, v2_1_test_helper::domain_name(),
            v2_1_test_helper::subdomain_name(), 100);
    }
    ...
    fun test_transfer_subdomain(
        ...
        v2_1_domains::transfer_subdomain_owner(user,
            v2_1_test_helper::domain_name(),
        ...
        let is_owner =
            v2_1_domains::is_token_owner(rando_addr,
                v2_1_test_helper::domain_name(),
                option::some(v2_1_test_helper::subdomain_name()));
        let is_expired =
...

        {
            ...
            let is_owner =
                v2_1_domains::is_token_owner(user_addr,
                    v2_1_test_helper::domain_name(),
                    option::some(v2_1_test_helper::subdomain_name()),);
            assert!(is_owner, 1);
        }
    ...
    fun test_non_domain_owner_transfer_subdomain(
...

        {
            ...
            v2_1_domains::transfer_subdomain_owner(rando,
                v2_1_test_helper::domain_name(),
                v2_1_test_helper::subdomain_name(),
                user_addr,
                option::some(user_addr));
    ...
    fun test_set_expiration_date_for_subdomain(
        ...
        v2_1_domains::set_subdomain_expiration(user,
            v2_1_test_helper::domain_name(),
            v2_1_test_helper::subdomain_name(),
    ...
    fun test_get_target_address_for_subdomain(
        ...
        v2_1_test_helper::set_target_address(user,
            ...
            user_addr);
        let target_address =
            v2_1_domains::get_target_address(v2_1_test_helper::domain_name(),
                option::some(v2_1_test_helper::subdomain_name()));
    ...
    fun test_dont_allow_rando_to_set_subdomain_address_e2e(
        ...
        v2_1_test_helper::set_target_address(rando,
            v2_1_test_helper::domain_name(),
            option::some(v2_1_test_helper::subdomain_name()),
            @aptos_names_v2_1);
    }
    ...
    fun test_admin_can_force_set_subdomain_address_e2e(
        ...
        let target_address =
            v2_1_domains::get_target_address(v2_1_test_helper::domain_name(),
                option::some(v2_1_test_helper::subdomain_name()));
        v2_1_test_utils::print_actual_expected(b"set_subdomain_address: ", target_address,
    ...
    fun test_rando_cant_force_set_subdomain_address_e2e(
        ...
        v2_1_domains::force_set_target_address(rando,
            v2_1_test_helper::domain_name(),
            option::some(v2_1_test_helper::subdomain_name()),
            rando_addr);
    }
    ...
    fun test_subdomain_reset(
        ...
        // The subdomain should be clear (expired, no target addr, no owner)
        {
            assert!(v2_1_domains::is_name_expired(v2_1_test_helper::domain_name(),
                ...
                3);
            let owner_addr =
                v2_1_domains::get_name_owner_addr(option::some(v2_1_test_helper::subdomain_name()),
                    v2_1_test_helper::domain_name());
