...
module aptos_names_v2_1::v2_1_domain_e2e_tests {
    ...
    #[test(router_signer = @router_signer, aptos_names_v2_1 = @aptos_names_v2_1, user = @0x077, aptos = @0x1, rando = @0x266f, foundation = @0xf01d)]
    fun test_happy_path_e2e(
        ...
        let users =
            v2_1_test_helper::e2e_test_setup(aptos_names_v2_1, user, &aptos, rando, &foundation);
        ...
        v2_1_test_helper::set_target_address(user, v2_1_test_helper::domain_name(),
            option::none(), user_addr);

        // Ensure the owner can clear the address
        v2_1_test_helper::clear_target_address(user, option::none(),
            v2_1_test_helper::domain_name());

        // And also can clear if the user is the registered address, but not owner
        v2_1_test_helper::set_target_address(user, v2_1_test_helper::domain_name(),
            option::none(), signer::address_of(rando));
        v2_1_test_helper::clear_target_address(rando, option::none(),
            v2_1_test_helper::domain_name());
    ...
    fun test_renew_domain_e2e(
        ...
        let expiration_time_sec =
            v2_1_domains::get_expiration(v2_1_test_helper::domain_name(), option::none());

        // Set the time is early than max remaining time for renewal from expiration time
        timestamp::update_global_time_for_test_secs(expiration_time_sec - MAX_REMAINING_TIME_FOR_RENEWAL_SEC
            - 5);
        assert!(!v2_1_domains::is_domain_in_renewal_window(v2_1_test_helper::domain_name()),
            1);
        ...
        assert!(v2_1_domains::is_name_registered(v2_1_test_helper::domain_name(),
                option::none()), 4);
        ...
        assert!(v2_1_domains::is_name_expired(v2_1_test_helper::domain_name(),
                option::none()), 5);
    }
    ...
    fun test_names_are_registerable_after_expiry_and_past_grace_period(
        ...
        assert!(v2_1_domains::is_name_registered(v2_1_test_helper::domain_name(),
                option::none()), 81);
        assert!(v2_1_domains::is_name_registerable(v2_1_test_helper::domain_name(),
                option::none()), 82);
        ...
        assert!(option::is_none(&v2_1_domains::get_reverse_lookup(signer::address_of(user))),
            85);
    ...
    fun test_non_owner_can_not_set_target_address(
        ...
        v2_1_test_helper::set_target_address(rando, v2_1_test_helper::domain_name(),
            option::none(), @aptos_names_v2_1);
    }

    #[test(router_signer = @router_signer, aptos_names_v2_1 = @aptos_names_v2_1, user = @0x077, aptos = @0x1, rando = @0x266f, foundation = @0xf01d)]
    #[expected_failure(abort_code = 327682, location = aptos_names_v2_1::v2_1_domains)]
    fun test_non_owner_can_not_clear_target_address(
        ...
        v2_1_test_helper::register_name(router_signer,
            ...
            1);
        v2_1_test_helper::set_target_address(user, v2_1_test_helper::domain_name(),
            option::none(), signer::address_of(user));
    ...
    fun test_get_target_address_for_domain(
        ...
        v2_1_test_helper::set_target_address(user, v2_1_test_helper::domain_name(),
            option::none(), user_addr);
        let target_address =
            v2_1_domains::get_target_address(v2_1_test_helper::domain_name(), option::none());
    ...
    fun test_get_reverse_lookup_for_domain(
        ...
        v2_1_test_helper::register_name(router_signer,
            ...
            v2_1_test_helper::fq_domain_name(),
            1);
        aptos_names_v2_1::v2_1_domains::set_reverse_lookup(user, option::none(),
            v2_1_test_helper::domain_name());
        let token_addr =
            v2_1_domains::get_token_addr(v2_1_test_helper::domain_name(), option::none());
        assert!(v2_1_domains::get_reverse_lookup(user_addr)
            == option::some(token_addr), 1);
    ...
    fun test_admin_can_force_set_target_address_e2e(
        ...
        v2_1_domains::force_set_target_address(aptos_names_v2_1,
            v2_1_test_helper::domain_name(), option::none(), rando_addr);
        let target_address =
            v2_1_domains::get_target_address(v2_1_test_helper::domain_name(), option::none());
        v2_1_test_utils::print_actual_expected(b"set_domain_address: ", target_address,
            option::some(rando_addr), false);
    ...
    fun test_rando_cant_force_set_target_address_e2e(
        ...
        v2_1_domains::force_set_target_address(rando, v2_1_test_helper::domain_name(),
            option::none(), rando_addr);
    }
    ...
    fun test_admin_can_force_renew_domain_name(
        ...
        v2_1_test_helper::register_name(router_signer,
            ...
            1);
        let is_owner =
            v2_1_domains::is_token_owner(signer::address_of(user),
                v2_1_test_helper::domain_name(), option::none());
        let is_expired =
            v2_1_domains::is_name_expired(v2_1_test_helper::domain_name(), option::none());
        assert!(is_owner && !is_expired, 1);

        let expiration_time_sec =
            v2_1_domains::get_expiration(v2_1_test_helper::domain_name(), option::none());
        assert!(expiration_time_sec / SECONDS_PER_YEAR == 1, expiration_time_sec / SECONDS_PER_YEAR);

        // renew the domain by admin outside of renewal window
        v2_1_domains::force_set_name_expiration(aptos_names_v2_1,
            v2_1_test_helper::domain_name(),
            option::none(),
        ...
        let expiration_time_sec =
            v2_1_domains::get_expiration(v2_1_test_helper::domain_name(), option::none());
        assert!(expiration_time_sec / SECONDS_PER_YEAR == 2, expiration_time_sec / SECONDS_PER_YEAR);
    }
    ...
    fun test_admin_can_force_seize_domain_name(
        ...
        v2_1_domains::force_create_or_seize_name(aptos_names_v2_1,
            v2_1_test_helper::domain_name(),
            option::none(),
            v2_1_test_helper::two_hundred_year_secs());
        let is_owner =
            v2_1_domains::is_token_owner(signer::address_of(aptos_names_v2_1),
                v2_1_test_helper::domain_name(), option::none());
        let is_expired =
            v2_1_domains::is_name_expired(v2_1_test_helper::domain_name(), option::none());
        ...
        let expiration_time_sec =
            v2_1_domains::get_expiration(v2_1_test_helper::domain_name(), option::none());
        assert!(expiration_time_sec / SECONDS_PER_YEAR == 200, expiration_time_sec / SECONDS_PER_YEAR);

        // Ensure that the user's primary name is no longer set.
        assert!(option::is_none(&v2_1_domains::get_reverse_lookup(user_addr)), 1);
    }

    #[test(aptos_names_v2_1 = @aptos_names_v2_1, user = @0x077, aptos = @0x1, rando = @0x266f, foundation = @0xf01d)]
    fun test_admin_can_force_create_domain_name(
        ...
        assert!(v2_1_domains::is_name_registered(v2_1_test_helper::domain_name(),
                option::none()), 3);
        v2_1_domains::force_clear_registration(aptos_names_v2_1,
            v2_1_test_helper::domain_name(), option::none());
        assert!(!v2_1_domains::is_name_registered(v2_1_test_helper::domain_name(),
                option::none()), 4);
    }
    ...
    fun test_rando_cant_force_seize_domain_name(
        ...
        // Take the domain name for much longer than users are allowed to register it for
        v2_1_domains::force_create_or_seize_name(rando,
            v2_1_test_helper::domain_name(),
            option::none(),
            v2_1_test_helper::two_hundred_year_secs());
    }
    ...
    fun test_owner_of_expired_name_is_not_owner(
        ...
        v2_1_test_helper::register_name(router_signer,
            ...
            1);
        let is_owner =
            v2_1_domains::is_token_owner(user_addr, v2_1_test_helper::domain_name(),
                option::none());
        let is_expired =
            v2_1_domains::is_name_expired(v2_1_test_helper::domain_name(), option::none());
        assert!(is_owner && !is_expired, 1);
    ...
    fun test_transfer(
        ...
        // user is owner
        {
            let is_owner =
                v2_1_domains::is_token_owner(user_addr, v2_1_test_helper::domain_name(),
                    option::none());
            let is_expired =
                v2_1_domains::is_name_expired(v2_1_test_helper::domain_name(),
                    option::none());
            assert!(is_owner && !is_expired, 1);
        };
        ...
        {
            let is_owner =
                v2_1_domains::is_token_owner(rando_addr, v2_1_test_helper::domain_name(),
                    option::none());
            let is_expired =
                v2_1_domains::is_name_expired(v2_1_test_helper::domain_name(),
                    option::none());
    ...
    #[test(router_signer = @router_signer, aptos_names_v2_1 = @aptos_names_v2_1, user = @0x077, aptos = @0x1, rando = @0x266f, foundation = @0xf01d)]
    #[expected_failure(abort_code = 393221, location = aptos_names_v2_1::v2_1_domains)]
    ...
    fun test_register_during_reregistration_grace(
        ...
        v2_1_config::set_reregistration_grace_sec(aptos_names_v2_1, 30 * SECONDS_PER_DAY);
