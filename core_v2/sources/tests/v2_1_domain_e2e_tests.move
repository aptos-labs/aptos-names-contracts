...
module aptos_names_v2_1::v2_1_domain_e2e_tests {
    ...
    fun test_names_are_registerable_after_expiry_and_past_grace_period(
        ...
        assert!(v2_1_domains::get_reverse_lookup(signer::address_of(user)).is_none(), 85);
    ...
    fun test_non_owner_can_not_set_target_address(
        ...
        v2_1_test_helper::set_target_address(rando, v2_1_test_helper::domain_name(), option::none(), @aptos_names_v2_1);
    }
    ...
    fun test_get_reverse_lookup_for_domain(
        ...
        // Register the domain
        v2_1_test_helper::register_name(router_signer, user, option::none(), v2_1_test_helper::domain_name(), v2_1_test_helper::one_year_secs(), v2_1_test_helper::fq_domain_name(), 1);
        aptos_names_v2_1::v2_1_domains::set_reverse_lookup(user, option::none(), v2_1_test_helper::domain_name());
        ...
        timestamp::update_global_time_for_test_secs(v2_1_test_helper::one_year_secs() + 5);
        assert!(v2_1_domains::get_reverse_lookup(user_addr).is_none(), 1);
    }
    ...
    fun test_admin_can_force_set_target_address_e2e(
        ...
        v2_1_domains::force_set_target_address(aptos_names_v2_1, v2_1_test_helper::domain_name(), option::none(), rando_addr);
        let target_address = v2_1_domains::get_target_address(v2_1_test_helper::domain_name(), option::none());
    ...
    fun test_admin_can_force_renew_domain_name(
        ...
        v2_1_domains::force_set_name_expiration(aptos_names_v2_1, v2_1_test_helper::domain_name(), option::none(), timestamp::now_seconds() + 2 * v2_1_test_helper::one_year_secs());
    ...
    fun test_admin_can_force_seize_domain_name(
        ...
        v2_1_domains::force_create_or_seize_name(aptos_names_v2_1, v2_1_test_helper::domain_name(), option::none(), v2_1_test_helper::two_hundred_year_secs());
        let is_owner = v2_1_domains::is_token_owner(signer::address_of(aptos_names_v2_1), v2_1_test_helper::domain_name(), option::none());
        let is_expired = v2_1_domains::is_name_expired(v2_1_test_helper::domain_name(), option::none());
    ...
    fun test_admin_can_force_create_domain_name(
        ...
        let _ = v2_1_test_helper::e2e_test_setup(aptos_names_v2_1, user, &aptos, rando, &foundation);
        ...
        v2_1_domains::force_clear_registration(aptos_names_v2_1, v2_1_test_helper::domain_name(), option::none());
        assert!(!v2_1_domains::is_name_registered(v2_1_test_helper::domain_name(), option::none()), 4);
    }
    ...
    fun test_cannot_set_unregistered_name_as_primary_name(
        ...
        aptos_names_v2_1::v2_1_domains::set_reverse_lookup(user, option::none(), string::utf8(b"notexist"));
    }
